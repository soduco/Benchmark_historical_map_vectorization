...
class bdcn(nn.Module):
    ...
    def forward(self, x):
        ...
        self.features.features[1].register_forward_hook(get_features('conv1_1'))
        self.features.features[3].register_forward_hook(get_features('conv1_2'))
        self.features.features[6].register_forward_hook(get_features('conv2_1'))
        self.features.features[8].register_forward_hook(get_features('conv2_2'))
        self.features.features[11].register_forward_hook(get_features('conv3_1'))
        self.features.features[13].register_forward_hook(get_features('conv3_2'))
        self.features.features[15].register_forward_hook(get_features('conv3_3'))
        self.features.features[18].register_forward_hook(get_features('conv4_1'))
        self.features.features[20].register_forward_hook(get_features('conv4_2'))
        self.features.features[22].register_forward_hook(get_features('conv4_3'))
        self.features.features[25].register_forward_hook(get_features('conv5_1'))
        self.features.features[27].register_forward_hook(get_features('conv5_2'))
        self.features.features[29].register_forward_hook(get_features('conv5_3'))
        self.features(x)

        features = [values for key, values in i_features.items()]
